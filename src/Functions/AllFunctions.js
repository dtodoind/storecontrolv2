            ...
            await axios.get('https://storecontrolserverv2-production.up.railway.app/salesactivity')
                .then(async item => {
                    ...
                    if(con === undefined && (log.Type === 'Manager' || log.Type === 'Master Manager')) {
                        ...
                        main_data = data
                        await axios.post('https://storecontrolserverv2-production.up.railway.app/salesactivity/new', data)
                        ...
                        if(window.desktop) {
                            ...
                            await window.api.getAllData("Sales_Activity").then(async (item2) => {
                                if(item2.Sales_Activity === undefined) {
                                    ...
                                    await axios.post('https://storecontrolserverv2-production.up.railway.app/salesactivity/new', another_data[another_data.length - 1])
                                }
                            })
                        }
                    } else {
...
export const store_Products = async (naming, Status, Products, allproduct, setAllPro, Sales_Activity, allorders, allsalesactivity, CategoryAdd=null, filtered_cat=null) => {
    if(Products.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserverv2-production.up.railway.app/product").then(async (item) => {
                ...
                if(filtered_cat !== null) {
                    if(CategoryAdd.length === 0) {
                        await axios.get("https://storecontrolserverv2-production.up.railway.app/category").then(async (category_data) => {
                    ...
                    await window.api.getAllData("Products").then(async (item2) => {
                        await window.api.getAllData("Orders_Returns").then(async (order_ret) => {
                            if(order_ret.Orders_Returns) {
                                ...
                                order_ret.Orders_Returns.forEach(async (ret) => {
                                    await axios.put('https://storecontrolserverv2-production.up.railway.app/product/quantity', {Product_id: ret.Product_id, Stock: ret.Stock})
                                    ...
                                    console.log(ret)
                                    if(ret.del) {
                                        await axios.delete(`https://storecontrolserverv2-production.up.railway.app/ordermaster/delete/${ret.order.Order_id}`)
                                    } else {
                                    ...
                                    await axios.delete(`https://storecontrolserverv2-production.up.railway.app/orderproduct/delete/${ret.val.Order_pro_id}`)
                                    .then(async item => {
                                        await axios.get('https://storecontrolserverv2-production.up.railway.app/ordermaster')
                                            .then(async prod => {
                                                ...
                                                await axios.get('https://storecontrolserverv2-production.up.railway.app/salesactivity').then(async item3 => {
                        ...
                        item2.Products.forEach(async function (pro, index) {
                            ...
                            if (!Object.keys(pro).includes('createdAt')) {
                                ...
                                await axios.post("https://storecontrolserverv2-production.up.railway.app/product/new", convert_data).then(async (item) => {
                                ...
                                await axios.put('https://storecontrolserverv2-production.up.railway.app/product/edit', edit_val).then(res => {
                        ...
                        await window.api.getAllData("Products_Returns").then(async (product_ret) => {
                            if(product_ret.Products_Returns) {
                                ...
                                product_ret.Products_Returns.forEach(async (ret) => {
                                    await axios.delete(`https://storecontrolserverv2-production.up.railway.app/product/delete/${ret.Product_id}`);
                                    await axios.get("https://storecontrolserverv2-production.up.railway.app/product").then(async (item) => {
                        ...
                        //         }
                        //         if (flag === 0) {
                        //             await axios.delete(`https://storecontrolserverv2-production.up.railway.app/product/delete/${alldata[h].Product_id}`);
                        //             await axios.get("https://storecontrolserverv2-production.up.railway.app/product").then(async (item) => {
                        //                 console.log(`${naming} -> Delete`)
                        //                 var alldata = item.data
                        //                 if (alldata.length > 0) {
...
export const store_Category = async (naming, Status, CategoryAdd, category) => {
    if(CategoryAdd.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserverv2-production.up.railway.app/category").then(async (item) => {
                    ...
                    await window.api.getAllData("CategoryAdd").then(async (item2) => {
                        item2.CategoryAdd.forEach(async function (cate) {
                            if (!Object.keys(cate).includes('createdAt')) {
                                await axios.post('https://storecontrolserverv2-production.up.railway.app/category/new', cate).then(async (item3) => {
                        ...
                        //             await axios.delete(`https://storecontrolserverv2-production.up.railway.app/category/delete/${c.Category_id}`)
                    ...
                    await window.api.getAllData("Category_Returns").then(async (category_ret) => {
                        if(category_ret.Category_Returns) {
                            category_ret.Category_Returns.forEach(async (ret) => {
                                await axios.delete(`https://storecontrolserverv2-production.up.railway.app/category/delete/${ret.Category_id}`)
                    ...
                    await window.api.getAllData("Expenses_Returns").then(async (expense_ret) => {
                        if(expense_ret.Expenses_Returns) {
                            expense_ret.Expenses_Returns.forEach(async (ret) => {
                                await axios.delete(`https://storecontrolserverv2-production.up.railway.app/expense/delete/${ret.Expense_id}`).then(async dele => {
                                    await axios.get("https://storecontrolserverv2-production.up.railway.app/expense").then(async (item7) => {
...
export const store_NotifyMaster = async (naming, Status, Notific, notify) => {
    if(Notific.length === 0){
        if(Status) {
            await axios.get("https://storecontrolserverv2-production.up.railway.app/notification").then(async item => {
                    ...
                    await window.api.getAllData("Notification").then(async (item2) => {
                        item2.Notification.forEach(async notify_data => {
                            if(notify_data.Notify_id === undefined) {
                                await axios.post("https://storecontrolserverv2-production.up.railway.app/notification/new",{
...
export const store_Clients = async (naming, Status, Clients, allClients, allprovince) => {
    if(Clients.length === 0) {
        if(Status) {
            await axios.get("https://storecontrolserverv2-production.up.railway.app/register").then((response) => {
